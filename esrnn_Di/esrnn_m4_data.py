"""This module is a copy of m4_data.py from ESRNN.

ESRNN relies on numpy 1.16. Here, we modify the source code for numpy 2.
"""
...
def naive2_predictions(dataset_name, directory, num_obs, y_train_df = None, y_test_df = None):
    ...
    for unique_id in unique_ids:
        ...
        y_naive2_df.append(y_naive2)
    y_naive2_df = pd.concat(y_naive2_df)
